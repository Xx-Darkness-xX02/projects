...
while($row = mysqli_fetch_array($data)) {
    ...
    $url = "http://localhost/website/signature";
        ...
        echo '<div style="margin-top: 5px; margin-left: 5px; background-color:'. $row['color_icon'] .'; border-radius: 50%; display: inline-block; height: '.$row['icon_height'].'; width: 33px; text-align: center;"><img src="'.$url.'/goede_icons/'.$row['icon_email'] .'" style="padding-top: 8px; "></div><p  class="icontekst" style="display: inline-block; margin: -20px 0 0 10px;">' . $row['email'] . '</p><br/>';
        echo '<div style="margin-top: 5px; margin-left: 5px; background-color:'. $row['color_icon'] .'; border-radius: 50%; display: inline-block; height: '.$row['icon_height'].'; width: 33px; text-align: center;"><img src="'.$url.'/goede_icons/'.$row['icon_telefoon'] .'" style="padding-top: 8px; "></div><p  class="icontekst" style="display: inline-block; margin: -20px 0 0 10px;">' . $row['telefoonnummer'] . '</p><br/>';
        echo '<div style="margin-top: 5px; margin-left: 5px; background-color:'. $row['color_icon'] .'; border-radius: 50%; display: inline-block; height: '.$row['icon_height'].'; width: 33px; text-align: center;"><img src="'.$url.'/goede_icons/'.$row['icon_website'].'" style="padding-top: 8px; "></div><p class="icontekst" style="display: inline-block; margin: -20px 0 0 10px;">' . $row['website'] . '</p><br/>';

        // twitter ROW deze is niet verplicht
        if (!empty($row['twitter'])) {
            echo '<div style="margin-top: 5px; margin-left: 5px; background-color:'. $row['color_icon'] .'; border-radius: 50%; display: inline-block; height: '.$row['icon_height'].'; width: 33px; text-align: center;"><img src="'.$url .'/goede_icons/'. $row['icon_twitter'] .'" style="padding-top: 8px; "></div><p class="icontekst" style="display: inline-block; margin: -20px 0 0 10px;">' .$row['twitter'] . '</p><br/>';
        }

        // linkedIN ROW deze is niet verplicht
        if (!empty($row['linkedin'])) {
            echo '<div style="margin-top: 5px; margin-left: 5px; background-color:'. $row['color_icon'] .'; border-radius: 50%; display: inline-block; height: '.$row['icon_height'].'; width: 33px; text-align: center;"><img src="'.$url .'/goede_icons/'. $row['icon_linkedin'] .'" style="padding-top: 8px;"></div><p class="icontekst" style="display: inline-block; margin: -20px 0 0 10px;">' . $row['linkedin'] . '</p><br/>';
        }
